...
from orchid_distribution_map import create_distribution_map, get_distribution_summary
import json
import logging
...
def orchid_botanical_analysis(id):
    ...
    try:
        ...
        # Generate distribution map and summary
        distribution_map_html = create_distribution_map(orchid)
        distribution_summary = get_distribution_summary(orchid)
        ...
        return render_template('orchid_detail_enhanced.html', 
                             ...
                             distribution_map=distribution_map_html,
