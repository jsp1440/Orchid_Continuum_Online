...
def generate_ai_description():
    ...
    try:
        ...
        if ai_description:
            ...
            ai_description = f'A film featuring orchids or botanical themes, directed by {director} in {year}.'
        ...
        return jsonify({
            ...
            'fallback_description': f'A film featuring orchids or botanical themes, directed by {director} in {year}.'
        })
...
def get_movie_reviews(movie_key):
    ...
    try:
        ...
        review_count = int(stats.review_count) if stats and stats.review_count else 0
        avg_rating = round(float(stats.avg_rating), 1) if stats and stats.avg_rating else 0.0
        avg_orchid_rating = round(float(stats.avg_orchid_rating), 1) if stats and stats.avg_orchid_rating else 0.0
        ...
        return jsonify({
            ...
            'stats': {
                ...
                'avg_orchid_rating': avg_orchid_rating
            }
        })
