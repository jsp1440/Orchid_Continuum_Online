...
class NeonOneWidgetManager:
    ...
    def __init__(self):
        self.widget_catalog = {
            ...
            'gallery_hub': {
                'name': 'Themed Gallery Hub',
                'description': 'Comprehensive gallery with browse, themed collections, and member galleries',
                'category': 'browse_discover',
                'embed_url': '/neon-one/embed/gallery_hub',
                'preview_url': '/neon-one/preview/gallery_hub',
                'features': ['themed_galleries', 'member_collections', 'advanced_filtering', 'tab_navigation']
            },
            ...
            'hollywood_orchids': {
                ...
                'embed_url': '/neon-one/embed/hollywood_orchids',
                'preview_url': '/neon-one/preview/hollywood_orchids',
            ...
            'fcos_judge': {
                'name': 'FCOS Orchid Judge PWA',
                'description': 'Educational orchid judging tool with AI analysis, OCR, and certificate generation',
                'category': 'education_games',
                'embed_url': '/neon-one/embed/fcos-judge',
                'preview_url': '/neon-one/preview/fcos-judge',
                'features': ['mobile_first', 'ocr_tag_reading', 'ai_flower_analysis', 'symmetry_scoring', 'certificate_generation', 'google_sheets_integration', 'offline_capable']
            },
            ...
            # 🎮 GAMES & COMMUNITY WIDGETS
            'leaderboard': {
                'name': 'Game Leaderboard',
                'description': 'Real-time game scores and achievements display',
                'category': 'education_games',
                'embed_url': '/neon-one/embed/leaderboard',
                'preview_url': '/neon-one/preview/leaderboard',
                'features': ['live_scores', 'game_filtering', 'achievements', 'auto_refresh']
            },
            'article_submission': {
                'name': 'Article Submission Form',
                'description': 'Public article submission with markdown preview',
                'category': 'utilities',
                'embed_url': '/neon-one/embed/article-submit',
                'preview_url': '/neon-one/preview/article-submit',
                'features': ['markdown_editor', 'live_preview', 'category_selection', 'validation']
            },
            ...
            'admin_dashboard': {
                ...
                'category': 'utilities',
                'embed_url': '/neon-one/embed/admin-dashboard',
                'preview_url': '/neon-one/preview/admin-dashboard',
                'features': ['real_time_stats', 'activity_charts', 'user_analytics', 'performance_metrics']
            },
            'upload_validation': {
                'name': 'Photo Upload & Validation',
                'description': 'AI-powered photo upload with validation preview',
                'category': 'utilities',
                'embed_url': '/neon-one/embed/upload-validate',
                'preview_url': '/neon-one/preview/upload-validate',
                'features': ['drag_drop', 'ai_validation', 'metadata_extraction', 'preview']
            },
            'search_advanced': {
                'name': 'Advanced Orchid Search',
                'description': 'Powerful search with filters and facets',
                'category': 'browse_discover',
                'embed_url': '/neon-one/embed/search',
                'preview_url': '/neon-one/preview/search',
                'features': ['text_search', 'genus_filter', 'habitat_filter', 'bloom_time_filter']
            }
        }
...
def widget_embed(widget_id):
    ...
    template_map = {
        ...
        'hollywood_orchids': 'widgets/hollywood_orchids.html',
        'gallery_hub': 'gallery_hub.html',
        ...
        'fcos_judge': 'fcos_judge_index.html',
        ...
        'leaderboard': 'widgets/leaderboard_widget.html',
        'article_submission': 'widgets/article_submission_widget.html',
        'admin_dashboard': 'widgets/admin_dashboard_widget.html',
        'upload_validation': 'widgets/upload_validation_widget.html',
        'search_advanced': 'widgets/search_widget.html'
    }
    
    template = template_map.get(widget_id, 'neon_one/widgets/default.html')
    
    # Special handling for Hollywood Orchids widget
    if widget_id == 'hollywood_orchids':
        from hollywood_orchids_widget import HOLLYWOOD_ORCHIDS_MOVIES
    ...
    # Special handling for Gallery Hub widget
    if widget_id == 'gallery_hub':
