#!/usr/bin/env python3
"""Add all 25 NAOCC Orchid-Gami species to BloomBuilder"""
import sys
...
# All 25 species from NAOCC Orchid-Gami project
ALL_ORCHIDGAMI_SPECIES = [
...
print("🌸 Adding all 25 NAOCC Orchid-Gami species to BloomBuilder...\n")

with app.app_context():
    added = 0
    existing_count = 0
    
    for species_data in ALL_ORCHIDGAMI_SPECIES:
    ...
    print(f"   Already existed: {existing_count} species")
    print(f"   Total in database: {total} species")
    print(f"\n✅ BloomBuilder now has complete NAOCC Orchid-Gami collection!")
