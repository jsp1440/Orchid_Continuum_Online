...
class JudgingSystems {
    ...
    initializeRubrics() {
        return {
            ...
            "TOGA": {
                "name": "Taiwan Orchid Growers Association (Educational)",
                "sections": [
                    {"key":"form","label":"Form / Symmetry","weight":0.30,"maxScore":30},
                    {"key":"color","label":"Color & Pattern","weight":0.20,"maxScore":20},
                    {"key":"size","label":"Size / Substance","weight":0.20,"maxScore":20},
                    {"key":"floriferous","label":"Floriferousness","weight":0.15,"maxScore":15},
                    {"key":"condition","label":"Condition & Presentation","weight":0.10,"maxScore":10},
                    {"key":"distinct","label":"Distinction & Quality","weight":0.05,"maxScore":5}
                ],
                "awardBands":[
                    {"label":"Third Class Award (edu)","min":75,"max":79,"color":"#cd7f32"},
                    {"label":"Second Class Award (edu)","min":80,"max":89,"color":"#c0c0c0"},
                    {"label":"First Class Award (edu)","min":90,"max":100,"color":"#ffd700"}
                ],
                "totalScore": 100
            },
            "CSA": {
                "name": "Cymbidium Society of America (Educational)",
                "sections": [
                    {"key":"form","label":"Form / Shape","weight":0.35,"maxScore":35},
                    {"key":"color","label":"Color / Pattern","weight":0.20,"maxScore":20},
                    {"key":"size","label":"Size / Substance","weight":0.15,"maxScore":15},
                    {"key":"floriferous","label":"Spike & Floriferousness","weight":0.15,"maxScore":15},
                    {"key":"condition","label":"Condition","weight":0.10,"maxScore":10},
                    {"key":"distinct","label":"Distinction","weight":0.05,"maxScore":5}
                ],
                "awardBands":[
                    {"label":"Bronze Award (edu)","min":75,"max":79,"color":"#cd7f32"},
                    {"label":"Silver Award (edu)","min":80,"max":89,"color":"#c0c0c0"},
                    {"label":"Gold Award (edu)","min":90,"max":100,"color":"#ffd700"}
                ],
                "totalScore": 100
            },
            "SAOC": {
                "name": "South African Orchid Council (Educational)",
                "sections": [
                    {"key":"form","label":"Form / Symmetry","weight":0.30,"maxScore":30},
                    {"key":"color","label":"Color","weight":0.20,"maxScore":20},
                    {"key":"size","label":"Size / Texture","weight":0.15,"maxScore":15},
                    {"key":"floriferous","label":"Floriferousness","weight":0.20,"maxScore":20},
                    {"key":"condition","label":"Condition / Staging","weight":0.10,"maxScore":10},
                    {"key":"distinct","label":"Overall Quality","weight":0.05,"maxScore":5}
                ],
                "awardBands":[
                    {"label":"Certificate (edu)","min":75,"max":79,"color":"#cd7f32"},
                    {"label":"Merit Award (edu)","min":80,"max":89,"color":"#c0c0c0"},
                    {"label":"Excellence Award (edu)","min":90,"max":100,"color":"#ffd700"}
                ],
                "totalScore": 100
            },
            "WOC": {
                "name": "World Orchid Conference (Educational)",
                "sections": [
                    {"key":"form","label":"Form & Structure","weight":0.30,"maxScore":30},
                    {"key":"color","label":"Color & Presentation","weight":0.20,"maxScore":20},
                    {"key":"size","label":"Size & Substance","weight":0.15,"maxScore":15},
                    {"key":"floriferous","label":"Floral Display","weight":0.20,"maxScore":20},
                    {"key":"condition","label":"Condition","weight":0.10,"maxScore":10},
                    {"key":"distinct","label":"Distinction & Impact","weight":0.05,"maxScore":5}
                ],
                "awardBands":[
                    {"label":"Bronze Certification (edu)","min":75,"max":79,"color":"#cd7f32"},
                    {"label":"Silver Certification (edu)","min":80,"max":89,"color":"#c0c0c0"},
                    {"label":"Gold Certification (edu)","min":90,"max":100,"color":"#ffd700"}
                ],
                "totalScore": 100
            }
        };
