...
BYPASS SSL verification to work in Replit environment
...
class EOLTaxonomyFetcher:
    ...
    def get_page_taxonomy(self, page_id):
        ...
        try:
            ...
            # BYPASS SSL verification - necessary for Replit
            ...
            if taxonomy:
                if self.update_database(img['id'], taxonomy):
                    ...
                    if taxonomy.get('scientific_name'):
                        print(f"  ✓ {taxonomy['scientific_name']}")
            else:
                self.failed += 1
...
def main():
    ...
    print("SSL verification bypassed for Replit compatibility")
    print("="*80)
    ...
    print("Testing with first 10 images...")
    fetcher.process_all_images(limit=10)
    
    print("\n✓ Test complete. Check results in database.")
    print("\nIf successful, run with limit=None to process all 95,000 images.")
    print("Estimated time: ~13-26 hours for 95,000 images at 0.5 sec/image")
