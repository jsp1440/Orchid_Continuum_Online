...
def get_ethnobotany_for_genus(genus_name):
    """
    Retrieve ethnobotany data for a given genus
    Returns None if genus not in database
    """
    return ETHNOBOTANY_DATABASE.get(genus_name)
